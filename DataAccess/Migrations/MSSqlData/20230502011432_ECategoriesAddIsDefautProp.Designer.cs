...
namespace DataAccess.Migrations.MSSqlData
{
    ...
    [Migration("20230502011432_ECategoriesAddIsDefautProp")]
    partial class ECategoriesAddIsDefautProp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.ESmtpSettings", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationTime = new DateTime(2023, 5, 2, 4, 14, 32, 193, DateTimeKind.Local).AddTicks(9794),
                            DefaultTitle = " Şifre Yönetimi",
                            From = "your@email.net",
