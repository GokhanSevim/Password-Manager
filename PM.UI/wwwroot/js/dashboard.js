(function ($) {
    ...
    const ChartInit = () => {
            ...
            let chart = new Chart(el, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        label: 'Çalınan Kimlik Bilgileri',
                ...
                options: {
                    ...
                    tooltips: {
                        ...
                        custom: function (tooltipModel) {
                            // Tooltip Element
                            let tooltipEl = document.getElementById('overallIncomeChartTooltip' + i);
                            ...
                            if (tooltipModel.body) {
                                ...
                                let tableRoot = tooltipEl.querySelector('.u-tooltip-body');
                            ...
                            $(window).on('scroll', function () {
                                let position = $self._chart.canvas.getBoundingClientRect(),
                                    tooltipWidth = $(tooltipEl).outerWidth(),
                                    tooltipHeight = $(tooltipEl).outerHeight();
        ...
        $('.js-doughnut-chart').each(function (i, el) {
            let data = JSON.parse(el.getAttribute('data-set')),
